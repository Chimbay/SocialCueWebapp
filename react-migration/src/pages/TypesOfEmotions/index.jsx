    ...
    return (
        <>
            <div className="container" id="container">
                ...
                <div className="emotion-wrapper">
                    <div className="emotion">Sad</div>
                </div>
                <div className="emotion-wrapper">
                    <div className="emotion">Angry</div>
                </div>
                <div className="emotion-wrapper">
                    <div className="emotion">Surprised</div>
                </div>
                <div className="emotion-wrapper">
                    <div className="emotion">Scared</div>
                </div>
                <div className="emotion-wrapper">
                    <div className="emotion">Anxious</div>
                </div>
            </div>
            <dialog id="emotion-modal">
                <h1 id="emotion-heading"></h1>
